...
int main() {
  ...
  printFixed128(
      &a,
      "17185.3377787950294118167406283437248504242234048433601856231689453125");
  putchar('\n');
  printf("b:       ");
  printFixed128(
      &b, "4660.6711019557134972677962803100371047548833303153514862060546875");
  putchar('\n');
  Fixed128_sub(&c, &a, &b);
  printf("a-b:     ");
  printFixed128(
      &c,
      "12524.6666768393159145489443480336877456693400745280086994171142578125");
  putchar('\n');
  Fixed128_sub(&c, &b, &a);
  printf("b-a:     ");
  printFixed128(
  ...
  printf("a*b:     ");
  printFixed128(&c,
                "-0.01220388411722718446927871127627440728247165679931640625");
  putchar('\n');
  ...
  printf("(2⁻³²)²: ");
  printFixed128(
      &c, "0.0000000000000000000542101086242752217003726400434970855712890625");
  putchar('\n');
